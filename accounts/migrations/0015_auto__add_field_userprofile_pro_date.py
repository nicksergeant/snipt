...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.pro_date'
        db.add_column(u'accounts_userprofile', 'pro_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.pro_date'
        db.delete_column(u'accounts_userprofile', 'pro_date')
